...
namespace WebShopApp.Migrations
{
    ...
    [Migration("20250210104117_alterApplicationUser2")]
    partial class alterApplicationUser2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebShopApp.DAL.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebShopApp.DAL.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebShopApp.DAL.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebShopApp.DAL.Models.Order", b =>
                {
                    b.HasOne("WebShopApp.DAL.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
